...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Abhishek Singh

        \vspace{0.3 cm}
        \normalsize
        
        \mbox{\hrefWithoutArrow{mailto:abhisheksdtu@gmail.com}{\color{black}{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}abhisheksdtu@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+916388913980}{\color{black}{\footnotesize\faPhone*}\hspace*{0.13cm}+916388913980}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        % \AND%
        % \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/abhisheksdtu}{\color{black}{\footnotesize\faLinkedinIn}\hspace*{0.13cm}abhisheksdtu}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/abhisheksdtu}{\color{black}{\footnotesize\faGithub}\hspace*{0.13cm}abhisheksdtu}}%
        
        % \kern 5.0 pt%
        % \mbox{\hrefWithoutArrow{mailto:abhisheksdtu@gmail.com}{abhisheksdtu@gmail.com}}%
        % \kern 5.0 pt%
        % \AND%
        % \kern 5.0 pt%
        % \mbox{\hrefWithoutArrow{tel:+916388913980}{+916388913980}}%
        % \kern 5.0 pt%
        % \AND%        
        % \mbox{Gurgaon, India}%
        % \kern 5.0 pt%
        ...
        % % \AND%        
        % \kern 5.0 pt%
        % \mbox{\hrefWithoutArrow{https://linkedin.com/in/abhisheksdtu}{linkedin.com/in/abhisheksdtu}}%
        % \kern 5.0 pt%
        % \AND%        
        % \kern 5.0 pt%
        % \mbox{\hrefWithoutArrow{https://github.com/abhisheksdtu}{github.com/abhisheksdtu}}%
    \end{header}
    ...
    \section{Education}
        \begin{twocolentry}{
            ...
            \textbf{Delhi Technological University}, B.Tech\end{twocolentry}
